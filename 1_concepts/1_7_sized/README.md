...
Provide tests for `CommandHandler<CreateUser>` implementation where `dyn UserRepository`(you need to create a new trait) is mocked with another hand-written type for testing purposes. 
